        ...
        >
          <div className="flex flex-col w-full mt-8">
            ...
            <p className="text-md font-light text-gray-400 ">
              Enthusiastic and motivated self-learning in Information Technology. Interested in
              exploring about Computer Network, Cloud Computing, DevSecops, and Web Development. Now
              I am looking for more experience in my field.
            </p>
          </div>
          <a href="http://blog.dama.ink" className="mt-2 block">
            Go to My Blog <FontAwesomeIcon className="ml-2" icon={faCircleArrowRight} />{' '}
          </a>

          <ul className="flex mt-2 gap-4 items-center">
            <li>
              <a href="https://github.com/radendi" rel="noreferrer" target="_blank">
                <FontAwesomeIcon size="2xl" icon={faGithub} />
              </a>
            </li>
            <li>
              <a href="https://instagram.com/damaasth" rel="noreferrer" target="_blank">
                <FontAwesomeIcon size="2xl" icon={faInstagram} />
              </a>
            </li>
            <li>
              <a href="htps://linkedin.com/damasukma" rel="noreferrer" target="_blank">
